...
for word in df['words']:
    line += 1
    print("Making positives - line: ", line,"/",samples)
    terms = word.split(", ")
...
for i in range(len(positives)):
    ...
    if( (r1 != r2) ):
        ...
        if (i%2000 == 0):
            print(i, "Negatives are discovered")


print( "Negatives: ", len(negatives), "Positives: ",  len(positives))
...
np.savetxt('FastText_input.txt', result.FT_format, fmt='%s', delimiter=" ", header=None)